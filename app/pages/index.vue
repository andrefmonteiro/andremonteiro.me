...
<template>
	<div>
		...
		<p>
			I work on web apps that solve someone's problem, wrapped with an intutive user experience. In the process, I enjoy learning about system design tradeoffs, data modelling, and the role of abstractions.
		</p>
