...
<template>
	<footer class="flex justify-between text-text-secondary text-sm md:flex-1">
		<p>© {{ currYear }} André Monteiro.</p>

		<ul
			class="flex gap-x-4 list-none"
			aria-label="Contact links"
		>
			<li>
				<a
					href="mailto:andrefmonteiro@outlook.com"
					aria-label="Email"
				>
